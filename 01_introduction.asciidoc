...
### Doubt - Since it is said that LN is not a blockchian nor it does produce a blockchain what do we mean by LN node. ###
### Soln - Nodes are not miners. :p ###
 ...
 * The Lightning Network uses onion routing, similar to the protocol used by The Onion Router (Tor) privacy network, so that even the nodes involved in routing a payment are only directly aware of their predecessor and successor in the payment route.
 [read more about onion routing here](https://www.google.com/search?q=onion+routing&rlz=1C1JZAP_enIN936IN936&sxsrf=ALiCzsadA-mckOgT9YygK9Gb1htskx6BRA%3A1654824631208&ei=t56iYv-yDIicseMPvceN2AE&ved=0ahUKEwi_6ruS3qH4AhUITmwGHb1jAxsQ4dUDCA4&uact=5&oq=onion+routing&gs_lcp=&sclient=gws-wiz-serp)
